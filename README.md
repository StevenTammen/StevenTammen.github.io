...
- Incorporating [Pandoc](http://pandoc.org/) into the build process (or an Org parser for [Go](https://golang.org/) if someone gets around to writing one)
