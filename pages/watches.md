...
- But digital watches have desirable features like stopwatches, timers, day/date, world time, alarms, precise time, etc.
...
- Make the lugs about as wide as the watch face (i.e., don't add width), the thicker the watch band material, the more it distributes pressure on the wrist. However, bigger (nylon or leather) bands also dry slower, and bigger lugs are heavier and more visually noticeable. Balance (e.g., 20mm) probably best.
- Lugs should be slightly curved, a ideal shape to fit different wrist sizes (some flatter, rounder, etc.). Should not stick out so far as to be uncomfortable.
...
- Case size: 38-40mm is proably the sweet spot of readability vs bulkiness.
   - Smaller = less likely to get in the way, impair movement, hit things, etc. But harder to read at a glance.
...
- PMMA has better mechanical properties than the crystals, which are hard but not *tough* (meaning they are more prone to shatter under high loads than deform). Highly domed crystals are bad due to large amounts of stress on perimeter to hold them in watch frame.
...
- Diving bezel (with minutes)
   ...
   - Clicks don't matter from a purely functional point of view. Jst one more thing that could break.
...
- Logic:
   - 12ths are optimal for minutes and seconds (divisions of 5). 12 is also a highly composite number: can be split into halves, thirds, fourths, sixths, eights, and twelfths. Optimal for reading relative time distances in the increments of 15, 20, 30 minutes etc. Also optimal for hours: on a face split into 12ths, 4ths = 3 hours, 3rds = 4 hours, halfs = 6 hours, while on a face split into 24ths 4ths = 6 hours, thirds = 8 hours, halfs = 12 hours.
      - Therefor 12ths should be prominently marked on the dial
   ...
   - Philosophically, it would makre sense if the hours hand revolved once every 24 hours
   - Readings hours in 24 segments will *always* be more difficult than reading hours in 12 segments due to more precise spatial recognition for the latter (bigger space, more visible, less cluttered/things to mix up).
   - Numbers on a face reduce legibility, especially when there are a lot of them. (Both minutes and hours).
...
- Passive illumination: lume and tritium
   - Lume has several advantages over tritium: tritium has a ~12 year half life, making it's really usable lifespan within 20 years. Lume paint has a theoretically longer lifespan, and are easier to reapply (than tritium insets).
   ...
   - Visibility increased by trying to set the lume to a wavelength close to # which appears brightest to human eyes (some variety of light green probably).
...
- Also best to have some form of active illumination to light up whole face.
   ...
   - Balance factors such as lifespa of light, drain on battery, readability, price.
   - Should light evenly.
...
- Nylon = easy to clean, really strong, can be made to be comfortable
- holes should have something to prevent fraying
- heavy duty, corrosion resistant hardware (e.g., stainless steel).
   
## Mechanical Watch Specific

- Movement should be hackable (seconds hands stop when crown is pulled out).
...
- Should have spare parts available in store along with the watch (spring bars, dials, replacement crystals, bezels, etc.).
- Make as many of the aspects customizable as possible (e.g., lug  curvature).
- Design webapp for the the designing of custom faces. Print Lume automatically?

## Todo

- Jumping hours hand -- saves energy, increases hours readability (at the cost of making incremental time telling with hour hands impossible).
