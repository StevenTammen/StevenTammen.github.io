...
- On the other hand, are inherently safer than cars due to 1) better vision (higher up on bikes with upright seating position, no blind spots, can easily turn head), 2) better acceleration, maneuverability, and handling, 3) better attention forced by being more “present” in the act of driving, and 4) make you assume less about your safety and therefore take less risks/be more risk conscious.
- Many causes of injury/accidents are entirely preventable
  ...
  - Beginners (first 6 months) not being cautious enough — people most vulnerable when they first start.
  - People not being cautious enough if they start riding a new motorcycle with different cornering and braking behavior.
  - Wheelies and other reckless behavior like street racing (hooliganry: squidly behavior)
- Some things are what I would call “less preventable”
  - Loose gravel, diesel spills, stalled cars, edge traps etc. around blind corners.
    - But you can choose a cornering line that gives you maximum visibility and traction control and choose to never be going faster than your sight range. This way even if something unavoidable comes up you will have reduced your risk envelope significantly.
  - Motorists turning left in front of you (biggest overall cause of motorcycle accidents/fatalities)
    - Wear visible clothing and helmet/run visible auxiliary lights on your bike (modular optional: flashing can be annoying). Reflective stuff for night.
    - Don’t stay in traffic near large trucks or buses as they block your view and the view other drivers have of you.
    - Always ease off the throttle, drop a gear, and ride the front brake when coming into intersections (shaving off 5-10 mph and being ready to stop if necessary)
    - Learn how to make quick stops without locking up the back tire and highsiding — > can shed most of the speed before you hit a car that pulls out in front of you if you are already on the front brake coming into an intersection.
...
- Philosophically, most of the time we only take ourselves places and have no need to haul other people or objects (outside of what can be reasonably fitted in top box/panniers). Passenger cars with 5 seats and a trunk that only transport one person from A to B are inherently wasteful. Smaller cars are better, as are some of the newer alternative vehicles, but motorcycles are basically the least mass that will safely get you from A to B. 
  - The advantage widens if they have aerodynamic characteristics and are ridden a lot at high speeds (tradeoffs however). Cars are generally more aerodynamic than motorcycles, but are still less energy efficient overall.
- Internal combustion engines are inherently inefficient: most vehicle engines have an efficiency on the order of 25% (google with academic sources). More is lost from the transmission process (every time one gear hits another some energy is lost to friction, e.g.), so by the time wheels get moved, even the energy that the engine did not waste inherently gets whittled down. Electric engines have around 90% efficiency, and the source power comes either from clean sources (renewable, nuclear) or from higher efficiency power plants with scrubbers and such (higher efficiencies and lower emissions that vehicle ICEs).
  - Automatic vs manual transmission on cars and bikes, lock up torque converters
- Cars have a whole host of yearly maintenance that is required. Compared to motorcycles, everything is bigger and costs more (a bigger engine and 4 tires instead of 2, for example). ICE motorcycles have to maintain chains, bla blah blah… belt-driven electric motorcycles only have to maintain tires and brakes. Maintenance costs overall will be significantly lower
...
- No vibration: long term comfort, won’t shake mirrors and make looking behind you more difficult.
...
- No energy is wasted idling. ICEs effectively waste money and create unnecessary fumes. (Some now give you the option of engine shutoff when stopped, however).
- High torque available at all times nearly instantaneously (with reasonable ramp up time if starting from zero for logical safety purposes). Can more easily accelerate to safety from any speed. Makes turns easier: just twist throttle to roll out, no need to worry about downshifting for torque.
...
- Takes away mental processing power from operating the clutch/shift pedal under all circumstances.
...
- Built in tank bag/storage, hollow top = lower center of gravity.
- Lack of vibration enables better sense of tire grip and available traction.
- You don’t have to sit on a hot engine… very beneficial for hot, humid day
...
- Windscreen increases buffeting if not adjusted properly
- For tall folks, windscreen has to be very large to get air to travel over helmet, will act as sail
- Windscreen can make ducking into wind to take load off arms impossible because of airflow and buffeting
- No air feedback on how fast you are going
- Increase *unpredicatable* effects of crosswinds and winds from semi's passing etc.
- Add weight and reduce handling (even if not by much)
- Make jacket vents useless if no airflow on chest (can always layer up in liner when raining/cold)
- Proper full face helmet and jacket/gloves/pants will protect from bugs and rocks
- No super extended trips means really long term comfort << safety and handling
- Using it to duck down in rain is not beneficial because it adds another layer of water splattered plastic. Does keep rain off body though (though with proper gear, this doesn’t matter).
...
- Make airflow/venting to hands impossible (good theoretically in winter, but again, that’s what gloves are for. Awful in summer. Taking them on and off can vary in difficulty, but if you want to get the best of both worlds, you could by season).
...
- Can measure speed by air resistance on body (assuming no windscreen)
