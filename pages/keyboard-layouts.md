...
Steno is unarguably faster than typing, and certain people would be better served learning stenography instead of a more optimized keyboard layout. I have written [a page that compares typing to stenography](https://steventammen.com/typing-versus-stenography/) -- [this section]((https://steventammen.com/typing-versus-stenography/#who-should-use-what) of the page is particularly relevant since it describes who, in my opinion, should learn stenography, and who should not.

Basically, if you get paid based on how much text you an enter (like transcriptonists), if most of what you type can be thought of as "conversational" (as if you were talking to someone but with words rather than speech), and/or if you need to be able to input text as fast as human speech for some reason (to transcribe lectures, for example), stenography is worth your while. Otherwise, it probably isn't, unless you don't view increased efficiency of text-input as the only variable. People without jobs related to the above who take up stenography as a hobby for fun and relaxation, for example, might argue that it is worth it despite the fact that they will never recoup the time they spend learning it from increased productivity.
